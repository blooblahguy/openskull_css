...
<div class="section">
	<div class="container">
		<div class="ultraform">
			<p>Forms should work out of the box. If you need very specific an advanced formatting, then anything other than exactly what you need would get in the way. We try and keep our forms as baseline as possible, while still offering the best possible user experience.</p>
			...
			<p>Lastly, if a <kbd>:required</kbd> element is <kbd>:valid</kbd> then it displays the <mark class="bg-success text-white">success</mark> color. User interactions like this make filling out forms feel fun and easy.</p>
