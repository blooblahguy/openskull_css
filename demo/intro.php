<div class="section">
	<div class="container">
		...
		<p>Instead, this framework is a collection of <strong>helper classes</strong> that you can combine to get your desired style while minimizing the amount of CSS you need to <em>unwrite</em>. This can help save a lot of time in development. </p>

		<hr>
		<div class="row g1 content-middle margb1">
			<div class="os-md-3 os-sm-12 text-center">
				<div class="row">
					<div class="os-12 padb2"><a href="/openskull.css" download class="display-block btn-primary">Download CSS</a></div>
